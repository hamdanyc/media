...
# Read html ----
theNews <- read_html("https://harakahdaily.net/index.php/category/nasional/")
...
src <- replicate(no.links,"harakahdaily")
...
Sys.sleep(1)
close(pb)
harakah.df <- tibble(src, datePub, headlines, newslink, article)
